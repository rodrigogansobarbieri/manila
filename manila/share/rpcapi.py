...
class ShareAPI(object):
    ...
    API version history:
        ...
        1.10 - Add migration_complete(), migration_cancel() and
            ...
            connection_get_info(), rename get_driver_connection_info() to
        ...
        1.12 - Add provide_remote_share_server() and
            create_remote_share_server(), removed connection_get_driver_info()
    """
    ...
    def migration_start(self, context, share, dest_host,
                        ...
                        writable, new_share_network_id, new_share_type_id):
