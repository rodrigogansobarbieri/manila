...
class ShareManager(manager.SchedulerDependentManager):
    ...
    def _migration_start_driver(self, context, share_ref, src_share_instance,
        ...
        try:
            ...
            driver_writable = self.driver.migration_check_writable(
                context, src_share_instance, dest_host,
                dest_driver_migration_info, dest_share_instance,
                share_server, dest_share_server)
    ...
    def _migration_complete_driver(
        ...
        export_locations = self.driver.migration_complete(
            context, src_share_instance, dest_host, dest_driver_migration_info,
            dest_share_instance, share_server, dest_share_server)
    ...
    def migration_cancel(self, context, src_instance_id, dest_instance_id):
        ...
        share_server = None
        if src_share_instance.get('share_server_id'):
            share_server = self.db.share_server_get(
        ...
        dest_driver_migration_info = self.driver.migration_get_driver_info(
            context, src_share_instance, dest_share_instance['host'])
