...
STATUS_TASK_STATE_MIGRATION_COPYING_IN_PROGRESS = (
    'migration_copying_in_progress'
)
STATUS_TASK_STATE_MIGRATION_COPYING_COMPLETED = 'migration_copying_completed'
STATUS_TASK_STATE_MIGRATION_COPYING_STARTING = 'migration_copying_starting'
STATUS_TASK_STATE_MIGRATION_COPYING_COMPLETING = 'migration_copying_completing'
...
BUSY_TASK_STATES = (
    ...
    STATUS_TASK_STATE_MIGRATION_COPYING_IN_PROGRESS,
    STATUS_TASK_STATE_MIGRATION_COPYING_COMPLETED,
    STATUS_TASK_STATE_MIGRATION_COPYING_STARTING,
    STATUS_TASK_STATE_MIGRATION_COPYING_COMPLETING,
)
