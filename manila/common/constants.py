...
TASK_STATE_MIGRATION_COPYING_IN_PROGRESS = 'migration_copying_in_progress'
TASK_STATE_MIGRATION_COPYING_COMPLETED = 'migration_copying_completed'
TASK_STATE_MIGRATION_COPYING_STARTING = 'migration_copying_starting'
TASK_STATE_MIGRATION_COPYING_COMPLETING = 'migration_copying_completing'
...
BUSY_TASK_STATES = (
    ...
    TASK_STATE_MIGRATION_COPYING_IN_PROGRESS,
    TASK_STATE_MIGRATION_COPYING_COMPLETED,
    TASK_STATE_MIGRATION_COPYING_STARTING,
    TASK_STATE_MIGRATION_COPYING_COMPLETING,
