...
TASK_STATE_DATA_JOB_PREPARING = 'data_copying_preparing'
...
TASK_STATE_DATA_JOB_SUCCESS = 'data_job_success'
TASK_STATE_DATA_JOB_FAILED = 'data_job_failed'
TASK_STATE_DATA_JOB_CANCELLED = 'data_job_cancelled'
...
OVERWRITE_POLICY_OVERWRITE = 'overwrite'
OVERWRITE_POLICY_FORCED_OVERWRITE = 'forced_overwrite'
OVERWRITE_POLICY_NO_OVERWRITE = 'no_overwrite'
OVERWRITE_POLICY_UPDATE = 'update'
OVERWRITE_POLICY_FORCED_UPDATE = 'forced_update'

OVERWRITE_POLICY_VALUES = (
    OVERWRITE_POLICY_FORCED_OVERWRITE,
    OVERWRITE_POLICY_FORCED_UPDATE,
    OVERWRITE_POLICY_NO_OVERWRITE,
    OVERWRITE_POLICY_OVERWRITE,
    OVERWRITE_POLICY_UPDATE
)
