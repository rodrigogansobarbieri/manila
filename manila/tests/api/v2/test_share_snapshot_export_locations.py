...
class ShareSnapshotExportLocationsAPITest(test.TestCase):
    ...
    def _get_request(self, version="2.31", use_admin_context=True):
    ...
    def test_index(self):
        ...
        out = self.controller.index(self._get_request('2.31'),
                                    self.snapshot['id'])
