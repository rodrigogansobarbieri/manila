...
class SchedulerManagerTestCase(test.TestCase):
    ...
    @ddt.data({'exc': exception.NoValidHost('fake'),
               'exc_class': exception.NoValidHost},
              {'exc': Exception('fake'), 'exc_class': Exception})
    @ddt.unpack
    def test_manage_share_exception(self, exc, exc_class):
        ...
        self.assertRaises(
            exc_class, self.manager.manage_share,
